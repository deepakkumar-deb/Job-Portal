            ...
            <div class="row">
                ...
                <div class=" col-md-3 mb-xs-3 mb-sm-3 mb-lg-0">
                    <div class="d-grid gap-2">
                        <button type="submit" href="{{route("jobs")}}" class="btn btn-primary btn-block">Search</button>
                    </div>
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-4 col-xl-3 col-md-6">
                <div class="single_catagory">
                    ...
                    {{-- <p class="mb-0"> <span>{{ $category->jobs->count() }}</span> Available position{{ $category->jobs->count() > 1 ? 's' : '' }}</p> --}}
                </div>      
            </div>
            @endforeach
            @endif
