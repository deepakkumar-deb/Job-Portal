                    ...
                    <div class="card border-0 shadow mb-4">
                        <div class="card-body card-form p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" name="qualifications" id="qualifications" rows="5" placeholder="Qualifications"></textarea>
                            </div>

                            <div class="mb-4">
                                <label class="mb-2">Experience</label>
                                <textarea class="form-control" name="experience" id="experience" rows="5" placeholder="Experience"></textarea>
                            </div>
